...
import wikipedia
​
page_py = wiki_wiki.page('Sydney')
print("Page - Exists: %s" % page_py.exists())
print("Page - Title: %s" % page_py.)
print(type(page_py.title))
...
​
data_json = sf_api_call("/services/data/v38.0/support/knowledgeArticles")
​
"""#Working with JSON"""
​
import json
...
​
    ...
    return out
​
flatten_json(list_attributes[0])
​
"""#Filtering data
​
​
